...
const swaggerOptions = {
  ...
  apis: ['./routes/apiRoutes/issuesRoutes.js','./routes/authRoutes/index.js','./routes/apiRoutes/projectRoutes.js'],
};
...
const swaggerCustomOptions = {  
  ...
  .topbar-wrapper:after{content:"IssUse Api | Created By IssUse Team : William, Chris, Abhijeet, Ryan, Lindsey";display:inline-block}`,
